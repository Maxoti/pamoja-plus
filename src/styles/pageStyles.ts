export const pageStyles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .btn-add { background: #1A3A2A; color: white; padding: 12px 24px; border-radius: 100px; font-size: 14px; font-weight: 600; border: none; cursor: pointer; font-family: 'DM Sans', sans-serif; transition: all 0.2s; display: flex; align-items: center; gap: 8px; }
